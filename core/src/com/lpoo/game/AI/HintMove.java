...
public class HintMove {
    ...
    public HintMove(char[][] board, int player){
        ...
        for(int i = 0; i <8; i++)
        {
            for(int j = 0; j < 8; j++)
            {
                chessBoard[i][j] = Character.toString(board[i][j]);
            }
        }
    ...
    public static String posibleMoves() {
        ...
        for (int i=0; i<64; i++) {
            ...
            } else if (chessBoard[i / 8][i % 8].equals("R")) {
                list += posibleR(i);

            } else if (chessBoard[i / 8][i % 8].equals("K")) {
                list += posibleK(i);

            } else if (chessBoard[i / 8][i % 8].equals("B")) {
                list += posibleB(i);

            } else if (chessBoard[i / 8][i % 8].equals("Q")) {
                list += posibleQ(i);

            } else if (chessBoard[i / 8][i % 8].equals("A")) {
                list += posibleA(i);
